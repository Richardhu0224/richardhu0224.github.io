...
1\. I analyzed TOT_LOANS for 2025Q2 (number of residential loans per state).

2\. Most states fall in the middle range.

3\. A few large states, like California and Texas, have much higher loan counts.

4\. Washington’s loan number is around the national average.

5\. From the ECDF, Washington ranks near the middle among all states.

6\. Overall, Washington is a mid-sized mortgage market — not extreme on either side.
